    ...
    public void RegisteringUser() {
        ...
        btnReg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UserHelperClass helperClass = new UserHelperClass(name, surname, date_of_birth, contact_no, email, username, password, user_role);
                ...
                Toast.makeText(RegistrationActivity.this, "User Account has been created", Toast.LENGTH_SHORT).show();
